  ...
  return (
    <>
      <section className="bg-primary py-12">
        <h2 className="text-center text-6xl font-bold text-white">LEVEL TWO</h2>
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-[#2A9D8F]">
              <span className="font-semibold">Duration:</span> 4 days + 7 days
              as intern at i-Revive Wellness Clinic
            </p>
            <p className="text-[#2A9D8F]">
            ...
            <div className="mt-10">
              ...
              <ul className="list-disc list-inside space-y-2 mt-2 font-lora text-xl text-[#264653]">
                <li>
                  ...
                  Advanced training backed by medical professionals.
                </li>
                <li>
                  <strong className="text-[#E9C46A]">
                    Hands-on Experience:
                  </strong>{" "}
                  Intern at a real wellness clinic.
                </li>
                <li>
                  <strong className="text-[#E9C46A]">
                    Globally Certified:
        ...
        <div className="mt-10">
          ...
          <ul className="list-disc list-inside space-y-2 mt-2 font-lora text-xl text-[#264653]">
            ...
            <li>
              <strong className="text-[#E9C46A]">Hands-on Experience:</strong>{" "}
              Intern at a real wellness clinic.
            </li>
            <li>
              <strong className="text-[#E9C46A]">Globally Certified:</strong>{" "}
              Meets international standards.
            </li>
          </ul>
        </div>
