        ...
        <div>
          ...
          <div className="mt-10">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>
                <strong>International Accreditation:</strong> Recognised by
                esteemed international bodies.
              </li>
              <li>
                <strong>Globally Certified Provider:</strong> Meets global
                standards for professional practice.
              </li>
              <li>
                <strong>Comprehensive Knowledge Base:</strong> Combines medical
              ...
              <li>
                <strong>Training by an Acclaimed Author:</strong> Learn from the
