      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="mt-10">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1 font-lora text-xl text-[#264653]">
              <li>
                <strong className="text-[#E9C46A]">Expertly Designed Curriculum:</strong> Developed under
                the guidance of leading professionals.
              </li>
              <li>
                <strong className="text-[#E9C46A]">International Accreditation:</strong> Recognised by
                esteemed international bodies.
              </li>
              <li>
                <strong className="text-[#E9C46A]">Globally Certified Provider:</strong> Meets global
                standards for professional practice.
              </li>
              <li>
                <strong className="text-[#E9C46A]">Comprehensive Knowledge Base:</strong> Combines medical
                science, metaphysical understanding, and Hijama practices.
              </li>
              <li>
                <strong className="text-[#E9C46A]">Proven Clinical Success:</strong> Learn from the
                expertise behind i-Revive Wellness Clinic.
              </li>
              <li>
                <strong className="text-[#E9C46A]">Training by an Acclaimed Author:</strong> Learn from the
                best-selling author of &quot;Hijama Inside&quot;.
              </li>
              <li>
                <strong className="text-[#E9C46A]">Hands-on Experience:</strong> Every student participates
            ...
            <ul className="list-disc list-inside mt-2 space-y-1 font-lora text-xl text-[#264653]">
              ...
              <li>
                Anatomy & Physiology (from a Hijama practitioner’s perspective)
              </li>
